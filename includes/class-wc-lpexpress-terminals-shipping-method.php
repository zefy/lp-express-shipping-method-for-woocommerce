...
class WC_LPExpress_Terminals_Shipping_Method extends WC_Shipping_Method {
	...
	public function __construct( $instance_id = 0 ) {
		...
		$this->method_title       = __( '"LP Express" parcel terminals', 'lpexpress-shipping' );
		$this->method_description = __( 'Shipping to "LP Express" self-service parcel terminals', 'lpexpress-shipping' );
		$this->supports           = array(
			'shipping-zones',
			'instance-settings',
	...
	public function init_form_fields() {
		$this->instance_form_fields = array(
			'title' => array(
				...
				'default'       => __( '"LP Express" parcel terminals', 'lpexpress-shipping' ),
				'desc_tip'      => true,
			),
	...
	public function validate_user_selected_terminal( $posted ) {
		...
		$error = __( 'Please select a parcel terminal', 'lpexpress-shipping' );
